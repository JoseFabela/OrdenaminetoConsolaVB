...
Class Game
    Public Shared Sub RunGame()
        ...
        Console.WriteLine("Ejército original:")
        PrintArmy(army)

        Dim sortingAlgorithm As ISortAlgorithm(Of Unit) = Nothing

        Do While sortingAlgorithm Is Nothing
            Console.WriteLine("Elija el algoritmo de ordenamiento:")
            ...
            Console.WriteLine("14. NaturalMergeSort")
            Console.WriteLine("15. StraightMergeSort")
            ...
            If Integer.TryParse(Console.ReadLine(), choice) Then
                ...
                If sortingAlgorithm IsNot Nothing Then
                    ...
                    Console.WriteLine(vbCrLf & "Ejército ordenado:")
                    PrintArmy(army)
                Else
                    Console.WriteLine("Opción no válida.")
                End If
            Else
                Console.WriteLine("Entrada no válida. Ingrese un entero válido.")
            End If
        Loop
    End Sub

    Private Shared Function GetSortingAlgorithm(choice As Integer) As ISortAlgorithm(Of Unit)
        Select Case choice
            Case 1
    ...
    Private Shared Sub PrintArmy(army As List(Of Unit))
        For Each unit In army
            Console.WriteLine(unit)
        Next
    End Sub

    Private Shared Function GenerateArmy() As List(Of Unit)
...
Module Program
    Sub Main()
        ...
        Do
            ...
            If resp = "n" OrElse resp = "N" Then
                siono = False
            ElseIf resp <> "y" AndAlso resp <> "Y" Then
                Console.WriteLine("ESCRIBA y PARA SI" & vbCrLf & "ESCRIBA n para No")
            End If
